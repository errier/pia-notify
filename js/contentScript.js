...
xhr.onreadystatechange = function () {
  ...
  if (hidden.getElementsByClassName('not-secured').length === 1) {
    ...
    warning.style.cssText = 'width: 100%; position: fixed; left: 0; top: 0; background-color: red; z-index: 2147483647; color: white; text-align: center; font-size: 18px; padding: 10px; box-shadow: 0px 5px 5px 0px rgba(170,170,170,1); animation: fade 1s linear forwards 2s;';
