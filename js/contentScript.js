...
xhr.onreadystatechange = function () {
  ...
  if (hidden.getElementsByClassName('not-secured').length === 1) {
    ...
    warning.style.cssText = 'width: 100%; position: fixed; left: 0; top: 0; background-color: red; z-index: 2147483647; color: white; text-align: center; font-size: 18px; padding: 10px; animation: fade 1s linear forwards 2s;';
